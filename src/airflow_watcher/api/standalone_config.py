...
class StandaloneConfig:
    ...
    def _load_from_env(self) -> None:
        ...
        shared_env_mappings: Dict[str, str] = {
            ...
            # Backend
            "AIRFLOW_WATCHER_BACKEND": "backend",
            "AIRFLOW_WATCHER_BQ_TABLE": "bq_table",
            "AIRFLOW_WATCHER_BQ_STRUCTURE": "bq_structure",
            "AIRFLOW_WATCHER_EXTERNAL_DB_URI": "external_db_uri",
            "AIRFLOW_WATCHER_SCHEMA_JSON": "schema_json",
        }
    ...
    def _validate(self) -> None:
        ...
        if self.backend in ("bigquery", "sqlalchemy"):
            # DB URI not needed — external backend reads from its own source.
            return
        if not self.db_uri:
            logger.error(
