...
def get_accessible_dag_ids(user=None) -> Optional[Set[str]]:
    ...
    Uses Airflow's security manager to resolve permissions. Admin users
    get None (meaning no restriction). Regular users get a set of DAG IDs
    they have 'can_read' permission on.
